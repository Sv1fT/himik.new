                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center d-flex flex-wrap align-items-center" style="">
                            <div class="w-100 h-100  image-bg" style='background-image:url({{ Storage::disk('local')->exists('file.jpg') ? asset('storage/' . $advert->filename) : "https://image.freepik.com/free-vector/error-404-found-glitch-effect_8024-4.jpg" }})'></div>
                        </div>
                ...
                @foreach ($new_adverts as $key => $advert)
                    <div class="my-2 col-lg-4 col-md-6 col-sm-12 ">
                        <div class="card h-100 shadow">
                            <img class="card-img-top" src="{{ Storage::disk('local')->exists('file.jpg') ? asset('storage/' . $advert->filename) : "https://image.freepik.com/free-vector/error-404-found-glitch-effect_8024-4.jpg"}}" alt="Card image cap">
                            <div class="card-body">
