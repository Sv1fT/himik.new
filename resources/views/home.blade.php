                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center d-flex flex-wrap align-items-center" style="">
                            <div class="w-100 h-100  image-bg" style='background-image:url({{ Storage::disk('local')->exists($top_day->filename) ? asset('storage/' . $advert->filename) : "https://image.freepik.com/free-vector/error-404-found-glitch-effect_8024-4.jpg" }})'></div>
                        </div>
